...
setupMock({
  setup: () => {
    Mock.mock(new RegExp('/mockapi/data-analysis/overview'), (params) => {
    ...
    Mock.mock(new RegExp('/mockapi/data-analysis/content-publishing'), () => {
      return [
        ...getTimeLine('纯文本'),
        ...getTimeLine('视频类'),
        ...getTimeLine('图文类'),
    ...
    Mock.mock(new RegExp('/mockapi/data-analysis/author-list'), () => {
      return Mock.mock({
        'list|8': [
          {
            'id|+1': 1,
