...
setupMock({
  setup: () => {
    Mock.mock(new RegExp('/mockapi/multi-dimension/overview'), () => {
    ...
    Mock.mock(new RegExp('/mockapi/multi-dimension/activity'), () => {
      const { list } = Mock.mock({
        'list|3': [
          {
            'name|+1': ['分享量', '评论量', '点赞量'],
    ...
    Mock.mock(new RegExp('/mockapi/multi-dimension/polar'), () => {
    ...
    Mock.mock(new RegExp('/mockapi/multi-dimension/card'), (params) => {
    ...
    Mock.mock(new RegExp('/mockapi/multi-dimension/content-source'), () => {
