...
import { getLivePrizePoolItemInfo } from '@/api/livePrizePoolItem';
        ...
        <Descriptions
          ...
          data={[
            ...
            },
            {
              ...
              value: infoData ? infoData.live_id : '',
            },
            {
              label: t['searchTable.columns.prize_id'],
              value: infoData ? infoData.prize_id : '',
            },
            {
            ...
            },
            {
              ...
              value: infoData ? infoData.remaining_quantity : '',
            },
            {
